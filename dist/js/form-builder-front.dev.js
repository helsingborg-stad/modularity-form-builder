...
FormBuilder.Front.getLocation = (function ($) {
    ...
    getLocation.prototype.handleEvents = function() {
        $('#form-get-location').click(function(e) {
            ...
            $(e.target).find('i').removeClass().addClass('spinner spinner-dark');
	        ...
	        navigator.geolocation.getCurrentPosition(
	            function(position) {
					...
					$(e.target).find('i').removeClass().addClass('pricon pricon-location-pin');
	            },
	            function() {

// Fix error handling
console.log("Something went wrong");
$(locationButton).after('<span>' + formbuilder.something_went_wrong + '</span>');
